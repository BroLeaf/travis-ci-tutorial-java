[![Build Status](https://travis-ci.com/joaomlneto/travis-ci-tutorial-java.svg?branch=master)](https://travis-ci.com/BroLeaf/travis-ci-tutorial-java)
[![Code Coverage](https://codecov.io/github/joaomlneto/travis-ci-tutorial-java/coverage.svg)](https://codecov.io/gh/BroLeaf/travis-ci-tutorial-java)
...
- Add your repository (you can go there directly by going to https://codecov.io/gh/BroLeaf/travis-ci-tutorial-java)
